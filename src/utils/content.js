...
export const section1Content = {
  ...
  subtitle: "blockchain for a better tomorrow.",
};

export const section2Content = {
  items: [
    { counter: 365, subtitle: "Days" },
    { counter: 345, before: "$", after: "B+", subtitle: "Hour" },
    { counter: 4.4, after: "M+", subtitle: "Min", decimals: true },
    { counter: 28.7, after: "M+", subtitle: "Secs", decimals: true },
  ],
};
...
export const section4Content = {
  top: {
    title: "Revolutionizing Blockchain. We bringing the beauty of blockchain close to you.",
    subtitle:
      "Our mission is to improve the freedom of money globally through the integration of institutions, people, groups and businesses into the blockchain economy.",
    image: NewsImg,
  },
  bottom: {
    title: "Get Familiar With More of our Products",
    TABS: [
      {
        name: "Alterverse ",
        image: Phone1Img,
        subtitle:
          "Alterverse is Stasha's art infrastructure which aims at bridging NFT and making it more user-centric. It's a unique NFT and metaverse wallet for storing, buying and owning exclusive nft contents, a delivery gateway for nft audio and visual streaming with AR/VR implementation.",
      },
      {
        name: "NFT Marketplace",
        image: Phone3Img,
        subtitle:
          "The NFT marketplace would allow users to cryptographically tokenize real life assets (real estate, arts, publications, music, movies) and have them auctioned for sale as well. .",
      },
      {
        name: "Staking Platforms",
        image: Phone5Img,
        subtitle: "Our staking platform gives users the leverage of creating two-way staking pools and earning profits according to determined APYs.",
      },
      {
        name: "Multisig Wallet ",
        image: Phone4Img,
        subtitle: "Suited for companies that have embraced decentralization and need to own asset vaults managed by various signatories.",
      },
...
export const section5Content = {
  ...
  title: "Why $STC?",
  subtitle:
    "By choosing Stasha, investors gain access to a forward-thinking platform that is revolutionizing the global blockchain landscape. With a range of innovative products, strategic partnerships, and a dedicated team, we are poised for significant growth and impact in the cryptocurrency space.Invest with confidence. Choose Stasha for a secure, innovative, and powerful blockchain experience..",
};
...
export const section8Content = {
  ...
  subtitle:
    "Stasha Ecosystem is a paradigm shifting blockchain infrastructure and solutions providing firm which aims to drive the adoption of blockchain technology through the freedom of money which would be realized through its various products and services. Vefi aims to be the standard for trustless and permissionless technology.Our cardinal focus is to build the future of DeFi, NFT and the Web3 ecosphere at large.",
  caption:
    "",
  ShieldImage,
};
  ...
  ITEMS: [
    {
      ...
      subtitle:
        "Stasha Smartchain is a new generation high-performant blockchain based on a unique consensus algorithm (S-DPoS), with the unique ability to process a bulk of transactions per second with almost zero transaction fees at a near-instant processing time.",
      image: Sec9Image1,
    },
    {
      title: "Stasha Exchanges",
      subtitle:
        "This is a flexible ecosystem which gives users access to all crypto products and services in a single platform.The Stasha exchange which would be a twofold exchange (DEx & CEx ) would have the following features: - Spot Trading - Margin Trading - Futures - Anonymous Instant Exchange",
      image: Sec9Image2,
    },
    {
      title: "Stasha Block Explorer",
      subtitle:
        "The Stasha Smartchain explorer will aid users in block traversals. Block & transaction information would be made available in realtime.",
      image: Sec9Image2,
    },
    {
      title: "Stasha Wallet",
      subtitle:
        "The Stasha wallet would be simplistically designed and intuitive for the crypto “newborns”. Housing various crypto assets, this product would be welcoming to the newbie in their transition into the crypto space.",
      image: Sec9Image2,
    },
  ],
};
